...
export type PaletteId = 'deepWater' | 'sunset' | 'forest' | 'midnight' | 'rose' | 'ocean' | 'ember' | 'lavender' | 'slate'
  ...
  | 'citrus' | 'graphite' | 'wine' | 'arctic' | 'jade' | 'sandstone' | 'neon' | 'moss'
  ...
  | 'cyberpunk' | 'electricViolet' | 'acidLime' | 'solarFlare' | 'hotMagenta' | 'electricBlue' | 'tangerine' | 'infrared';
...
export const PALETTES: PaletteDefinition[] = [
  ...
  {
    id: 'wine',
    previewColors: ['#9F1239', '#BE123C', '#D4A017'],
    gradientDark: ['#140409', '#210610', '#2C0814'],
    gradientLight: ['#FFFFFF', '#FFF7F9', '#FDEEF2'],
    auroraBlobs: {
      dark:  [['#9F1239','#4C0519'],['#BE123C','#7F1D1D'],['#D4A017','#78350F'],['#881337','#4C0519'],['#E11D48','#881337'],['#B45309','#451A03']],
      light: [['#FFE4E6','#FECDD3'],['#FECDD3','#FDA4AF'],['#FEF3C7','#FDE68A'],['#FFF1F2','#FFE4E6'],['#FDA4AF','#FB7185'],['#FEF9C3','#FEF08A']],
    },
    colors: {
      light: {
        primary: '#9F1239', primaryLight: '#FFF1F2', primaryDark: '#7E1030', onPrimary: '#FFFFFF',
        secondary: '#A16207', secondaryLight: '#FEFCE8', secondaryDark: '#854D0E', onSecondary: '#FFFFFF',
        tertiary: '#B45309', tertiaryLight: '#FFFBEB', tertiaryDark: '#92400E', onTertiary: '#FFFFFF',
        success: '#15803D', successLight: '#DCFCE7',
        info: '#9F1239', infoLight: '#FFF1F2',
        background: '#FFFFFF', backgroundSecondary: '#FFFAFB',
        surface: '#FFFFFF', surfaceSecondary: '#FDF2F4', surfaceElevated: '#FFF7F9',
        textPrimary: '#2A0611',
        border: '#F6DCE2', borderFocus: '#9F1239',
        inputBackground: '#FFF7F9', inputBorder: '#F0CBD4',
        ...FIXED_LIGHT,
      },
      dark: {
        primary: '#FB7185', primaryLight: '#4C0519', primaryDark: '#E11D48', onPrimary: '#3F0412',
        secondary: '#F0A93B', secondaryLight: '#3B1504', secondaryDark: '#D4A017', onSecondary: '#2A1200',
        tertiary: '#FCD34D', tertiaryLight: '#3B2A04', tertiaryDark: '#FBBF24', onTertiary: '#2A1D00',
        success: '#4ADE80', successLight: '#052E16',
        info: '#FB7185', infoLight: '#4C0519',
        background: '#140409', backgroundSecondary: '#1C0710',
        surface: '#240A15', surfaceSecondary: '#30101E', surfaceElevated: '#381425', surfaceOverlay: '#40182C',
        textPrimary: '#FBEDF1', textSecondary: '#C48C9C', textTertiary: '#BC8091', textInverse: '#140409',
        border: '#3A1424', borderFocus: '#FB7185',
        inputBackground: '#240A15', inputBorder: '#3A1424',
        ...FIXED_DARK,
      },
    },
  },
  ...
  {
    id: 'solarFlare',
    previewColors: ['#FABD05', '#F56A47', '#C96EF7'],
    gradientDark: ['#120F05', '#191508', '#29210A'],
    gradientLight: ['#FFFFFF', '#FEF7EE', '#FDE9CE'],
    auroraBlobs: {
      dark:  [['#FABD05','#554107'],['#F56A47','#551607'],['#C96EF7','#3B0755'],['#F3FC55','#5A5E08'],['#F65A6A','#5E0810'],['#BDF471','#40650B']],
      light: [['#FDEFDD','#FBE0BB'],['#FDE4DD','#FBC8BB'],['#F3DDFD','#E6BBFB'],['#FDFAE2','#FCF5C5'],['#FDE2E5','#FCC5CA'],['#F8FEE7','#F2FCCF']],
    },
    colors: {
      light: {
        primary: '#A75F01', primaryLight: '#FEF2E1', primaryDark: '#8A4E00', onPrimary: '#FFFFFF',
        secondary: '#D82E03', secondaryLight: '#FEE7E1', secondaryDark: '#B22400', onSecondary: '#FFFFFF',
        tertiary: '#B018FB', tertiaryLight: '#F5E1FE', tertiaryDark: '#8F00D6', onTertiary: '#FFFFFF',
        success: '#038142', successLight: '#DCFCE7',
        info: '#D82E03', infoLight: '#FEE7E1',
        background: '#FFFFFF', backgroundSecondary: '#FEF9F3',
        surface: '#FFFFFF', surfaceSecondary: '#FDF3E5', surfaceElevated: '#FEF9F1',
        textPrimary: '#291E0F',
        border: '#F2E2CC', borderFocus: '#A75F01',
        inputBackground: '#FEF9F1', inputBorder: '#EEDCC4',
        ...FIXED_LIGHT,
      },
      dark: {
        primary: '#FABD05', primaryLight: '#342909', primaryDark: '#FABD05', onPrimary: '#1D1602',
        secondary: '#F56A47', secondaryLight: '#341209', secondaryDark: '#F23B0D', onSecondary: '#1D0702',
        tertiary: '#C96EF7', tertiaryLight: '#260934', tertiaryDark: '#A60DF2', onTertiary: '#14021D',
        success: '#20DF80', successLight: '#0A291A',
        info: '#F56A47', infoLight: '#341209',
        background: '#120F05', backgroundSecondary: '#191508',
        surface: '#221D0E', surfaceSecondary: '#2E2715', surfaceElevated: '#362F19', surfaceOverlay: '#413920',
        textPrimary: '#F8F6F2', textSecondary: '#BDB8A8', textTertiary: '#B7B2A4', textInverse: '#120F05',
        border: '#433B23', borderFocus: '#FABD05',
        inputBackground: '#221D0E', inputBorder: '#433B23',
        ...FIXED_DARK,
      },
    },
  },
