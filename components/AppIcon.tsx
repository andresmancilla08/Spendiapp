...
const ICON_MAP = {
  ...
  'arrow-down': IconArrowNarrowDownDashed,
  'arrow-down-circle': IconCircleArrowDown,
  'arrow-forward': IconArrowRight,
  'arrow-up': IconArrowNarrowUpDashed,
  ...
  'arrow-down-outline': IconArrowNarrowDown,
  'arrow-up-outline': IconArrowNarrowUp,
  'cloud-download-outline': IconCloudDownload,
  'color-palette-outline': IconPalette,
  'contrast-outline': IconContrast,
  'ellipse-outline': IconCircle,
  'finger-print-outline': IconFingerprint,
  'flag': IconFlag,
  'grid-outline': IconLayoutGrid,
  'happy-outline': IconMoodHappy,
  'headset-outline': IconHeadphones,
  'help-circle-outline': IconHelpCircle,
  'mail-open-outline': IconMailOpened,
