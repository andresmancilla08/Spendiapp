      ...
      <SafeAreaView style={styles.safe}>
        <ScreenBackground>
          ...
          >
            ...
            <LegalBody i18nKey="legal.termsSections" vars={{ website: WEBSITE, email: CONTACT_EMAIL, phone: CONTACT_PHONE, updated: LAST_UPDATED }} />

            <View style={styles.footer}>
              <Text style={[styles.footerText, { color: colors.textTertiary }]}>
                {t('legal.rights', { year: LAST_UPDATED_AT.getFullYear() })}{'\n'}{t('legal.updatedTerms', { date: LAST_UPDATED })}
              </Text>
            </View>
          </ScrollView>
        </ScreenBackground>
