...
const styles = StyleSheet.create({
  ...
  balanceCardTitle: { fontFamily: Fonts.semiBold, fontSize: 12, marginBottom: 6, textTransform: 'uppercase' as const, letterSpacing: 0.5, textAlign: 'center' },
  balanceHero: { fontFamily: Fonts.bold, fontSize: 32, marginBottom: 14, textAlign: 'center' },
